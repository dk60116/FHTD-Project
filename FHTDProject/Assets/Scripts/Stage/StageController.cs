...
public class StageController : MonoBehaviour
{
    ...
    public void UpdateStageUnits()
    {
        ...
        {
            Unit _cNewUnit = InGameManager.instance.cEditMap.CreateChampionWithId(GameManager.instance.chapterList[GameManager.instance.selectedChapter].listStageUnits[sStageStat.iCrtStage - 1].listId[i]);
            _cNewUnit.attackUnit = true;
            _cNewUnit.body.transform.position += Vector3.down * 0.1f;
            (_cNewUnit as Hero).SetLevel(GameManager.instance.chapterList[GameManager.instance.selectedChapter].listStageUnits[sStageStat.iCrtStage - 1].listLevel[i]);
            (_cNewUnit as Hero).CreateHUD();
            listStageHero.Add(_cNewUnit as Hero);
        }
